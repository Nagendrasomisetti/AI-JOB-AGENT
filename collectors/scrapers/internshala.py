...
class InternshalaScraper(BaseCollector, BaseScraper):
    """
    ...
    def __init__(self, headless: bool = True):
        BaseCollector.__init__(self, name="Internshala", source_type="Scraper")
        ...
        try:
            ...
            for idx, card in enumerate(cards[:limit]):
                try:
                    ...
                    # Create standardized entry matching platform database columns
                    job_entry = {
                        "title": title,
                        "company": company,
                        "location": location,
