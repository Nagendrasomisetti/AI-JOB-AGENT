...
class WellfoundScraper(BaseScraper):
    ...
    Implements infinite scrolling, Cloudflare detection handling, and robust card text extraction.
    """
    def __init__(self, headless: bool = True):
        super().__init__(headless=headless)

    def scrape_jobs(self, query: str, max_results: int = 10) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            for idx, card in enumerate(cards[:max_results]):
                try:
                    ...
                    if link == "N/A":
                        # Fallback: get first link tag in the card
                        try:
                    ...
                    # Wellfound listings usually show salary directly on the summary card
